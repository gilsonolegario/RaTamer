...
public enum ControlCID {
    public static let dpiButton: UInt16 = 0x00C4
    public static let leftButton: UInt16 = 0x0050
    public static let rightButton: UInt16 = 0x0051
    public static let virtualGesture: UInt16 = 0x00B4
    public static let thumbGesture: UInt16 = 0x00C3
    public static let back: UInt16 = 0x0053
    public static let forward: UInt16 = 0x0056
}
...
public enum ControlTaskName {
    public static func name(for taskID: UInt16) -> String {
        ...
        case ControlCID.virtualGesture: return "Virtual Gesture"
